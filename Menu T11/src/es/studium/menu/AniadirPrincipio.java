...
public class AniadirPrincipio extends JFrame implements WindowListener, ActionListener
{
	...
	public AniadirPrincipio(){
		addWindowListener(this);
		setTitle ("Añadir Principio");
		setSize(300,190);
		//setVisible(true);
